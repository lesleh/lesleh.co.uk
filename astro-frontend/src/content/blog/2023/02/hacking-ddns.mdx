...
description: Learn how to hack the DynDNS protocol to update a custom DNS record instead of using their paid service, by reverse engineering the router requests and creating a serverless function to update Route53 records directly.
date: "2023-02-11"
---
