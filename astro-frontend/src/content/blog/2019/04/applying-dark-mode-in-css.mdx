...
description: Learn how to implement dark mode on your website using CSS custom properties and the prefers-color-scheme media query. Support for dark mode in Safari and Firefox allows adapting color schemes based on user system preferences.
date: "2019-04-21"
---
